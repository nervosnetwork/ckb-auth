...
INCLUDE_CKB_STD_CFLAGS = -I deps/ckb-c-stdlib-2025 -I deps/ckb-c-stdlib-2025/libc -I deps/ckb-c-stdlib-2025/molecule
...
PASSED_MBEDTLS_CFLAGS := $(CFLAGS) -DCKB_DECLARATION_ONLY -I ../../ckb-c-stdlib-2025/libc
...
CFLAGS_LIBECC_OPTIMIZED = -I ../ckb-c-stdlib-2025 -I ../ckb-c-stdlib-2025/libc -I ../ckb-c-stdlib-2025/molecule $(CFLAGS_LIBECC) -DWITH_LL_U256_MONT
...
build/dump_secp256k1_data_20210801: c/dump_secp256k1_data_20210801.c $(SECP256K1_SRC_20210801)
	mkdir -p build
	gcc -I deps/ckb-c-stdlib-2025 -I deps/secp256k1-20210801/src -I deps/secp256k1-20210801 -o $@ $<
